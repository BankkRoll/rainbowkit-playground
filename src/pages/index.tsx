        ...
        <Navbar />
          <div className="container mx-auto px-6 py-8 mt-10">
            ...
            <motion.p 
              ...
              variants={variants}
            >
              This is a live coding environment where you can experiment with the different features of RainbowKit in real-time. Select components, tweak their properties, and see the results as you code!
            </motion.p>
            ...
            >
              {features.map((feature, index) => (
                ...
                >
                  <span className="mb-4 w-16 h-16 flex items-center justify-center rounded-full bg-gradient-to-r from-green-400 via-blue-500 to-purple-600 text-white text-2xl font-bold">{feature[0]}</span>
